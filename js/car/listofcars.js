					...
					$("#categoryButtons").append('<button id="categoryBtn" class="btn btn-outline-success" value='+v.id+'>'+v.name+'</button>');
							...
							success: function(data)
							{
						    	...
						    	$.each(data, function(k, v){
										...
										htmlData += '<td><a href="editCar.php" class="btn btn-outline-warning" data-value="'+v.id+'" id="edit">Edit</a><a href="listAllCars.php" class="btn btn-outline-danger" data-value="'+v.id+'" id="delete" >Delete</a><br /></td>';
										htmlData += '</tr>';
